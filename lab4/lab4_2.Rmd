...
```{r}
not_al <- filter(fish, lakeid != "AL") # ! = not
```
...
```{r}
filter(fish, length %in% c(167, 175)) # pull out all fish with length 167 and 175 (within the variable "length")
```
