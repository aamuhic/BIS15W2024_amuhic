...
R is used for programming, whereas RStudio is the graphical user interface (GUI) that we can use to navigate and interact with R. GitHub is an online repository where we can upload our code, share with other users, and keep track of changes in our code.
